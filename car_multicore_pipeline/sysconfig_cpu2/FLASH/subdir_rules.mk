...
build-1934004607: ../led_ex2_blinky_sysconfig_cpu2.syscfg
	...
	"C:/ti/ccs1281/ccs/utils/sysconfig_1.21.0/sysconfig_cli.bat" --script "d:/GITHUB/28388D_176pin_25M/car_multicore_pipeline/sysconfig_cpu1/led_ex2_blinky_sysconfig_cpu1.syscfg" --context "CPU1" --script "d:/GITHUB/28388D_176pin_25M/car_multicore_pipeline/sysconfig_cpu2/led_ex2_blinky_sysconfig_cpu2.syscfg" -o "syscfg" -s "C:/ti/c2000/C2000Ware_5_01_00_00/.metadata/sdk.json" -d "F2838x" --context "CPU2" --compiler ccs
	@echo 'Finished building: "$<"'
	@echo ' '
